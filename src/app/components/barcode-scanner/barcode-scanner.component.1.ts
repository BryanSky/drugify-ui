...
export class BarcodeScannerComponent implements OnInit, AfterViewInit {
    ...
    public ngAfterViewInit(): void {
        ...
        this.scanInput.addEventListener("click", this.scan, false);
    }

    scan(){
        cordova.plugins.barcodescanner.scan(this.handleScanSuccess, this.handleFail);
    }
